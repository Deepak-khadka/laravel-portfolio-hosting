        ...
        <div class="col-lg-4 d-none d-lg-block ">
            ...
            <div class="box-color m-0 p-0 ">
                <div class="row gen center">
                    <p class="fs-2 fw-bold mb-4 text-center text-white mt-4">General Information</p>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end align-items-center text-secondary px-4 my-4">
